...
Notem como no exemplo do ReactNative, é super simples reutilizar o componente do Botão bastando alterar poucos valores. Este tipo de organização do código é (normalmente) inviável com HTML, CSS e JS puros.
